...
setup_PYTHIA() {
    export PYTHIA8LOCATION=/global/projecta/projectdirs/atlas/jzlin/corilibs/pythia8235/
...
setup_fastjet() {
    export FASTJETLOCATION=/global/projecta/projectdirs/atlas/jzlin/corilibs/fastjet-install/
    export LD_LIBRARY_PATH=/global/projecta/projectdirs/atlas/jzlin/corilibs/fastjet-install/lib/:$LD_LIBRARY_PATH
}
